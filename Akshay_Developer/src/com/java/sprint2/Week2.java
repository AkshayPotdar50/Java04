...
public class Week2 {
 ...
 String s9="you are very bad programmer";
 System.out.println(reverseWordsInSentense(s9));
 ...
 System.out.println("Joined with Streams: " + joinedWithStreams);
	...
	public static String reverseWordsInSentense(String str) {
		String[] words=str.split("\\s+");
		StringBuilder sb1= new StringBuilder();
		
		for(String word :words) {
			StringBuilder reversedWord=new StringBuilder(word).reverse();
			sb1.append(reversedWord).append(" ");
		}
